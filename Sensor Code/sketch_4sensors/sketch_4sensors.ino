...
void loop() {
  ...
  //   sprintf(txt + strlen(txt), "%d %d %d", sensor2.readRangeSingleMillimeters(), sensor2.readRangeSingleMillimeters(), sensor2.readRangeSingleMillimeters());// Serial.print(DISTANCE_FLT);
